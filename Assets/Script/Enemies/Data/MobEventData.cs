...
[CreateAssetMenu(fileName = "Mob Event Data", menuName = "ScriptableObject/Mob Event Data ")]
public class MobEventData : EventData
{
    ...
    public override bool Activate(PlayerStats player = null){
        //si attiva solo se il player esiste
        if(player){
            //altrimenti, spawniamo un mob al difuori della telecamera
            //e lo indiriziamo verso il player
